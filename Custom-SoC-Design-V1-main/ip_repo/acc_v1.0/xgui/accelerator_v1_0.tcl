...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "MM_HGT" -parent ${Page_0}
  ipgui::add_param $IPINST -name "MM_WDT" -parent ${Page_0}
...
proc update_PARAM_VALUE.MM_HGT { PARAM_VALUE.MM_HGT } {
	# Procedure called to update MM_HGT when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.MM_HGT { PARAM_VALUE.MM_HGT } {
	# Procedure called to validate MM_HGT
	return true
}

proc update_PARAM_VALUE.MM_WDT { PARAM_VALUE.MM_WDT } {
	# Procedure called to update MM_WDT when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.MM_WDT { PARAM_VALUE.MM_WDT } {
	# Procedure called to validate MM_WDT
	return true
}


proc update_MODELPARAM_VALUE.MM_HGT { MODELPARAM_VALUE.MM_HGT PARAM_VALUE.MM_HGT } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.MM_HGT}] ${MODELPARAM_VALUE.MM_HGT}
}

proc update_MODELPARAM_VALUE.MM_WDT { MODELPARAM_VALUE.MM_WDT PARAM_VALUE.MM_WDT } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.MM_WDT}] ${MODELPARAM_VALUE.MM_WDT}
}
